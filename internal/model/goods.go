...
type GoodsInfo struct {
	...
	GoodsType    int32     `gorm:"column:goods_type;not null;comment:商品分类" json:"goodsType"`                             // 商品分类
	GoodsName    string    `gorm:"column:goods_name;not null;comment:商品名称" json:"goodsName"`                             // 商品名称
	Price        int32     `gorm:"column:price;not null;comment:单价/分" json:"price"`                                      // 单价/分
	CoverImage   *string   `gorm:"column:cover_image;comment:封面图片" json:"coverImage"`                                    // 封面图片
	Sort         int32     `gorm:"column:sort;not null;comment:排序" json:"sort"`                                          // 排序
	PublishState int32     `gorm:"column:publish_state;not null;comment:上下架状态" json:"publishState"`                      // 上下架状态
