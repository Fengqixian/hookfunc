...
func (s *KLine) CalculateATR(data []model.LineItem, period int) []model.LineItem {
...
func (s *KLine) CalculateMACD(data []model.LineItem, sortEma, longEma, signalPeriod int64) []model.LineItem {
	if len(data) == 0 {
		return data
	}
...
func (s *KLine) CalculateKDJ(data []model.LineItem, N int) []model.LineItem {
	var kdj model.KDJ
